...
class Column implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets data_type
     *
     * @param string $data_type The data type of the column as documented https://docs.singlestore.com/managed-service/en/reference/sql-reference/data-types.html
     *
     * @return self
     */
